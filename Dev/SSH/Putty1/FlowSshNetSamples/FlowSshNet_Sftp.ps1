...
# To authenticate using a public key:
# $keypairData = Get-Content $keypairFilePath -Encoding Byte
# $keypair = [Bitvise.FlowSshNet.Keypair]::CreateFromData($keypairData, $keypairPassphrase)
